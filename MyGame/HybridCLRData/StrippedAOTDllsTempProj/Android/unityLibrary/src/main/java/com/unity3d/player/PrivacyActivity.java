...
public class PrivacyActivity extends Activity implements DialogInterface.OnClickListener {
    ...
    String privacyUrl = "https://gitee.com/shushuhs/TheBoom/blob/master/PrivacyPolicy.html";
    final String htmlStr = "欢迎使用本游戏，在使用本游戏前，请您充分阅读并理解<a href=\"https://gitee.com/shushuhs/TheBoom/blob/master/PrivacyPolicy.html\">《用户协议》</a>和<a href=\"https://gitee.com/shushuhs/TheBoom/blob/master/PrivacyPolicy.html\">《隐私政策》</a>各条\n" +
